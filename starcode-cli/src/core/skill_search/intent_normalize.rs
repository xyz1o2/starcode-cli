...
impl IntentNormalizer {
    pub fn new() -> Self {
        ...
        // 代码编辑关键词
        for word in &["edit", "modify", "change", "update", "fix", "refactor", "rewrite"] {
    ...
    pub fn normalize(&self, input: &str) -> NormalizedIntent {
        ...
        let mut intent_scores: std::collections::HashMap<IntentType, f64> = std::collections::HashMap::new();
        ...
        // 找到最高分的意图
        let (intent_type, score) = intent_scores.iter()
