//! Regression: task manager tests moved from src/core/tasks/tests.rs
//! (the TaskManager & TaskNode types are public => valid integration tests)

use starcode_cli::core::tasks::manager::{AddTaskOutcome, TaskManager};
use starcode_cli::core::tasks::models::TaskNode;
